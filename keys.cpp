...
//                std::cout<<"8"<<std::endl;
//                auto streak = find_longest_streak(p.begin(), p.end(), i);
//                auto streak = find_longest_streak_vector(p.begin(), p.end(), i);
//                auto streak_vector = find_longest_streak_vector(p.begin(), p.end(), i);
                key = buck[peak-cps.begin()].first.substr(0, i);
//                keys[key] += streak;
                keys[key] = find_longest_streak_vector(p.begin(), p.end(), i);
